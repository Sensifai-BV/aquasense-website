...
const useCases = [
  {
    title: "Windmill Maintenance",
    description: "Monitor water quality around wind farms to ensure environmental compliance and optimize maintenance schedules.",
    image: "https://images.unsplash.com/photo-1680302005329-bbd8324861bf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3aW5kbWlsbCUyMG1haW50ZW5hbmNlfGVufDF8fHx8MTc1ODAxNjA1Nnww&ixlib=rb-4.1.0&q=80&w=1080"
  },
  {
    title: "City Maintenance",
    description: "Real-time monitoring of urban water systems to prevent contamination and maintain public health standards.",
    image: "https://images.unsplash.com/photo-1699602050604-698045645108?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHxzbWFydCUyMGNpdHklMjB0ZWNobm9sb2d5fGVufDF8fHx8MTc1NzkyOTM1Mnww&ixlib=rb-4.1.0&q=80&w=1080"
  },
  {
    title: "Precision Agriculture",
    description: "Optimize irrigation and water quality for crops, ensuring sustainable farming practices and higher yields.",
    image: "https://images.unsplash.com/photo-1722119272044-fc49006131e0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHxwcmVjaXNpb24lMjBhZ3JpY3VsdHVyZSUyMHRlY2hub2xvZ3l8ZW58MXx8fHwxNzU4MDE2MDU2fDA&ixlib=rb-4.1.0&q=80&w=1080"
  },
  {
    title: "Fresh Food Supply",
    description: "Ensure water quality throughout the food supply chain, from farm to table, maintaining freshness and safety.",
    image: "https://images.unsplash.com/photo-1590671911659-3ce95e8b91c5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHxmcmVzaCUyMGZvb2QlMjBzdXBwbHklMjBjaGFpbnxlbnwxfHx8fDE3NTgwMTYwNTZ8MA&ixlib=rb-4.1.0&q=80&w=1080"
  },
  {
    title: "Crisis Management",
    description: "Rapid response systems for water contamination events, enabling quick action to protect communities.",
    image: "https://images.unsplash.com/photo-1753383850107-c045bb940c32?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjcmlzaXMlMjBtYW5hZ2VtZW50JTIwZW1lcmdlbmN5fGVufDF8fHx8MTc1ODAxNjA1Nnww&ixlib=rb-4.1.0&q=80&w=1080"
  }
];
...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-cyan-50/20">
              ...
              {useCases.map((useCase, index) => (
                <div key={index} className="group cursor-pointer">
                  <div className="bg-white/40 backdrop-blur-lg rounded-2xl overflow-hidden shadow-xl border border-white/30 hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:bg-white/60">
                    ...
                    <div className="p-6">
                      <h3
                        className="text-xl font-semibold text-gray-900 mb-3 group-hover:text-cyan-600 transition-colors duration-300"
                        style={{ fontFamily: "Montserrat, sans-serif" }}
                      >
                        {useCase.title}
                      </h3>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">contact@aquasense.com</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-xl flex items-center justify-center">
                  ...
                  <form className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          type="text"
                          className="w-full px-3 py-2 bg-white/70 border border-white/30 rounded-md focus:border-cyan-500 focus:outline-none"
                    ...
                    <div>
                      ...
                      <textarea
                        className="w-full px-3 py-2 bg-white/70 border border-white/30 rounded-md focus:border-cyan-500 focus:outline-none resize-none"
                        rows={5}
                        placeholder="Tell us about your water monitoring needs or partnership interests..."
                        required
                      />
                    </div>
                    <button
                      type="submit"
                      className="w-full bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                      style={{ fontFamily: "Montserrat, sans-serif" }}
                    >
                      Send Message
                    </button>
      ...
      {/* Footer */}
      <footer className="relative bg-white/40 backdrop-blur-lg border-t border-white/30">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
            <div className="lg:col-span-2">
              ...
              <p
                ...
                style={{ fontFamily: "Roboto, sans-serif" }}
              >
                Revolutionizing water quality monitoring through advanced IoT technology and
                AI-powered analytics. Protecting communities and environments with real-time,
            ...
            <div id="newsletter">
              ...
              <p
                ...
                style={{ fontFamily: "Roboto, sans-serif" }}
              >
                Get the latest updates on water quality monitoring technology and environmental
                insights.
              </p>
              <form className="space-y-3">
                <input
                  type="email"
                  className="w-full px-3 py-2 bg-white/70 border border-white/30 rounded-lg focus:border-cyan-500 focus:outline-none"
                  placeholder="Enter your email"
                  required
                />
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 py-2"
                  style={{ fontFamily: "Montserrat, sans-serif" }}
                >
                  Subscribe
                </button>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-6 text-sm text-gray-600">
                <span style={{ fontFamily: "Roboto, sans-serif" }}>
                  © 2024 AquaSense. All rights reserved.
                </span>
                <div className="flex space-x-6">
                  <a href="#" className="hover:text-cyan-600 transition-colors duration-200">
                    Privacy Policy
                  </a>
                  <a href="#" className="hover:text-cyan-600 transition-colors duration-200">
                    Terms of Service
              ...
              <button
                className="w-12 h-12 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-full flex items-center justify-center text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
        ...
        <div className="absolute top-0 left-0 w-32 h-32 bg-gradient-to-br from-cyan-200/10 to-blue-200/10 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-0 w-24 h-24 bg-gradient-to-br from-blue-200/10 to-cyan-200/10 rounded-full blur-2xl" />
      </footer>
    </div>
  );
}
